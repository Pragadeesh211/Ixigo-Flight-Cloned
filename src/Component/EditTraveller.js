...
import {addTraveller,setadded,deleteTraveller, editTraveller} from "../Redux/Slices/TravellerSlice";
...
const EditTraveller = () =>{
  ...
  const traveller = add?.[index] || {};
    console.log("Editing traveller index:", index);
     ...
     const [genderValue,setGenderValue] = useState(traveller.genderValue || "");
     const [DOBValue,setDOBValue] = useState(traveller.DOBValue || "");
  ...
  dispatch(editTraveller({ index: index, updatedData }));
            ...
            >
              ...
              >
                    <div style={{
                         ...
                         height:"30px",alignItems:"center",padding:10
                    }}>
                        <CloseOutlined style={{
                            position:"relative",color:"white",fontSize:"16px",
