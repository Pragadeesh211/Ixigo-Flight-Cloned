    ...
    return(
        ...
        <div>
            { returnSelectedFlight.map((item,idx)=>(
                                ...
                                fontSize:"23px",
                                fontWeight:"bold"
                              }}>{toCity} <ArrowRightOutlined style={{
                                fontSize:"18px"
                              }}/> {fromCity}</Text> <br />
                              <div style={{
                                position:"relative",
                              ...
                              <Text style={{
                                fontWeight:700,
                                fontSize:"15px" //heloo
                              }}>{ret.weekday}, {ret.day} {ret.month}</Text> <Text strong style={{
                              fontSize:"30px",
                              position:"relative",
                                bottom:"4px"
                            }}>.</Text>
                      ...
                      : item?.flightCodes || "--"}
                            ...
                            <div style={{
                              ...
                              <Text style={{
                                ...
                                {/* {selectedOnwards?.flightCodes?.[0]?.departureTime} */}
                                {item.stops === "1 stop"
                      ...
                      ?item?.flightCodes?.[1]?.toTerminal2 || "--":item?.toTerminal || "--"}
                              </Text>
                              </div>
                              <div style={{
                                marginTop:"30px",
                      ...
                      ?item?.flightCodes?.[0]?.duration1 || "--":item?.durations || "--"}</Text>
                              ...
                              }}>{ret.weekday}, {ret.day} {ret.month}</Text></div>}
                              <Text style={{
                                fontSize:"30px",
                                fontWeight:"bold"
                              }}>{item.stops === "1 stop"
                      ...
                      ?item?.flightCodes?.[0]?.toTerminal1 || "--":item.toTerminal}
                          ...
                          >
                            <Text style={{
                              ...
                              fontSize:"13px",
                              fontWeight:500
                            }}> layover in {item.flightCodes[0].toCity}  {returnSelectedFlight.layoverCity}</Text>
                          </div>
                          </div>
                        )}
                               {/* 1 stop design */}
                      ...
                      `${item?.flightCodes?.[0]?.to} - ${item?.flightCodes?.[0]?.toCity}` || "--"}
                              ...
                              <Text strong style={{
                                ...
                                Terminal {item?.flightCodes?.[0]?.toTerminal1 || "--"}
                              </Text>
                              </div>
                              <div>
                                <Text strong style={{
